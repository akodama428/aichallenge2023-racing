...
namespace dallara_interface {
  ...
  void DallaraInterface::actuation_callback(const ActuationCommandStamped::SharedPtr msg) {
    ...
    vehicle_inputs_msg.brake_cmd = msg->actuation.brake_cmd * 6000; // to Pascal
    ...
    // const double gear_ratio_1st = 2.9167;
    // const double gear_ratio_2nd = 1.8750;
    // const double gear_ratio_3rd = 1.3809;
    // const double gear_ratio_4th = 1.1154;
    // const double gear_ratio_5th = 0.9600;
