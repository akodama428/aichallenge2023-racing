...
#ifndef CORNER_PATH_PLANNER__CSV_LOADER_HPP_
#define CORNER_PATH_PLANNER__CSV_LOADER_HPP_
...
public:
  ...
  static std::vector<double> getColumnArray(const Table & table, const int & col);
...
#endif  // CORNER_PATH_PLANNER__CSV_LOADER_HPP_
